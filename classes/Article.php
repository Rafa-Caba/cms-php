...
class Article {
     ...
     * @param [string] $colums Optional list of columns for the select, default to *
     * 
    ...
    protected function validate() {
        ...
        if ($this->published_at != '') {
            $date_time = date_create_from_format('Y-m-d H:i:s', $date->format('Y-m-d H:i:s'));
    ...
    /**
     * Upodate the image file property
     *
     * @param object $conn Connection to the database
     * @param string $filename Tha Filename of the image file
     * 
    ...
    /**
     * Publish the article, setting the published_at at fiel to the current date and time
     *
     * @param object $conn Connection to the database
     * 
